...
namespace Nop.Web.Controllers
{
    public partial class OrderController : BasePublicController
    {
        ...
        public OrderController(IOrderService orderService, 
            ...
            ShippingSettings shippingSettings, AddressSettings addressSettings, CommonSettings commonSettings)
        {
        ...
        public ActionResult Details(int orderId)
        {
            ...
            var usaCountries = _countryService.GetAllUsaCountryCustome().Select(x => x.Id).ToArray();
                if (usaCountries.Contains(model.BillingAddress.CountryId.Value) && usaCountries.Contains(model.ShippingAddress.CountryId.Value))
            {
                model.BillingAddress.CountryId = USA;
                model.BillingAddress.CountryName = "USA";
                model.ShippingAddress.CountryId = USA;
                model.ShippingAddress.CountryName = "USA";
            }
            return View(model);
        }
