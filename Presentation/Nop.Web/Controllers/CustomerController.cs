...
namespace Nop.Web.Controllers
{
    public partial class CustomerController : BasePublicController
    {
        ...
        public CustomerController(IAuthenticationService authenticationService,
            ...
            CaptchaSettings captchaSettings, ExternalAuthenticationSettings externalAuthenticationSettings, CommonSettings commonSettings)
        {
        ...
        protected virtual void PrepareCustomerInfoModel(CustomerInfoModel model, Customer customer, bool excludeProperties)
        {
            ...
            if (!excludeProperties)
            {
                ...
                model.OrderNotification = customer.GetAttribute<bool>(SystemCustomerAttributeNames.GetOrderNotification);
            ...
            if (ModelState.IsValid)
            {
                ...
                switch (loginResult)
                {
                    case CustomerLoginResults.Successful:
                        {
                            var customer = _customerService.GetCustomerByUsernameorEmailId(model.Username);
        ...
        [NopHttpsRequirement(SslRequirement.Yes)]
        public ActionResult LoginReview(bool? checkoutAsGuest)
        {
            var model = new LoginModel();
            model.UsernamesEnabled = _customerSettings.UsernamesEnabled;
            model.CheckoutAsGuest = checkoutAsGuest.HasValue ? checkoutAsGuest.Value : false;
        ...
        public ActionResult LoginReviewValidate(string username, string password)
        {
            ...
            switch (loginResult)
            {
                case CustomerLoginResults.Successful:
                    {
                        var customer = _customerService.GetCustomerByUsernameorEmailId(username);
                ...
                case CustomerLoginResults.CustomerNotExist:
                    ModelState.AddModelError("", _localizationService.GetResource("Account.Login.WrongCredentials.CustomerNotExist"));
                    Session["LoginError"] = _localizationService.GetResource("Account.Login.WrongCredentials.CustomerNotExist");
                    return Json(new
                    {
                        success = false,
                        errormsg = _localizationService.GetResource("Account.Login.WrongCredentials.CustomerNotExist")

                    });

                case CustomerLoginResults.Deleted:
                    ModelState.AddModelError("", _localizationService.GetResource("Account.Login.WrongCredentials.Deleted"));
                    Session["LoginError"] = _localizationService.GetResource("Account.Login.WrongCredentials.Deleted");
                    return Json(new
                    {
                        success = false,
                        errormsg = _localizationService.GetResource("Account.Login.WrongCredentials.Deleted")

                    });

                case CustomerLoginResults.NotActive:
                    ModelState.AddModelError("", _localizationService.GetResource("Account.Login.WrongCredentials.NotActive"));
                    Session["LoginError"] = _localizationService.GetResource("Account.Login.WrongCredentials.NotActive");
                    return Json(new
                    {
                        success = false,
                        errormsg = _localizationService.GetResource("Account.Login.WrongCredentials.NotActive")

                    });

                case CustomerLoginResults.NotRegistered:
                    ModelState.AddModelError("", _localizationService.GetResource("Account.Login.WrongCredentials.NotRegistered"));
                    Session["LoginError"] = _localizationService.GetResource("Account.Login.WrongCredentials.NotRegistered");
                    return Json(new
                    {
                        success = false,
                        errormsg = _localizationService.GetResource("Account.Login.WrongCredentials.NotRegistered")
                ...
                default:
                    ModelState.AddModelError("", _localizationService.GetResource("Account.Login.WrongCredentials"));
                    Session["LoginError"] = _localizationService.GetResource("Account.Login.WrongCredentials");
                    return Json(new
                    {
                        success = false,
                        errormsg = _localizationService.GetResource("Account.Login.WrongCredentials")
            ...
            if (ModelState.IsValid)
            {
                ...
                if (registrationResult.Success)
                {
                    ...
                    if (_customerSettings.NewsletterEnabled)
                    {
                        ...
                        _genericAttributeService.SaveAttribute(customer, SystemCustomerAttributeNames.GetOrderNotification, model.OrderNotification);
                    ...
                    if (this._addressService.IsAddressValid(defaultAddress))
                    {
                        ...
                        //set default address
                        defaultAddress = CommonHelper.FormatAddress(defaultAddress);
        ...
        public ActionResult Addresses()
        {
            ...
            foreach (var address in addresses)
            {
                ...
                addressModel.PrepareModel(address, false, _addressSettings, _localizationService,
                    _stateProvinceService, _countryService, null, false, null);
        ...
        public ActionResult AddressAdd()
        {
            ...
            model.Address.PrepareModel(null, false, _addressSettings, _localizationService,
                    _stateProvinceService, _countryService, () => _countryService.GetAllCountries().Where(x => x.ThreeLetterIsoCode != "USA" && x.ThreeLetterIsoCode != "UMI").ToList());
        ...
        public ActionResult AddressAdd(CustomerAddressEditModel model)
        {
            ...
            if (model.Address.AddressType == "C" && string.IsNullOrEmpty(model.Address.Company))
            {
            ...
            if (ModelState.IsValid)
            {
                if (model.Address.FirstName != null)
                    address.FirstName = model.Address.FirstName.Trim();
                if (model.Address.LastName != null)
                    address.LastName = model.Address.LastName.Trim();
                if (model.Address.Email != null)
                    address.Email = model.Address.Email.Trim();
                if (model.Address.Company != null)
                    address.Company = model.Address.Company.Trim();
                if (model.Address.City != null)
                    address.City = model.Address.City.Trim();
                if (model.Address.Address1 != null)
                    address.Address1 = model.Address.Address1.Trim();
                if (model.Address.Address2 != null)
                    address.Address2 = model.Address.Address2.Trim();
                if (model.Address.ZipPostalCode != null)
                    address.ZipPostalCode = model.Address.ZipPostalCode.Trim();
                if (model.Address.PhoneNumber != null)
                    address.PhoneNumber = model.Address.PhoneNumber.Trim();
                if (model.Address.FaxNumber != null)
                    address.FaxNumber = model.Address.FaxNumber.Trim();
                ...
                if (model.Address.CountryId == USA)
                {
                    var state = _stateProvinceService.GetStateProvinceById(Convert.ToInt32(model.Address.StateProvinceId));
            ...
            model.Address.PrepareModel(null, true, _addressSettings, _localizationService,
                    _stateProvinceService, null, () => _countryService.GetAllCountries());
        ...
        public ActionResult PasswordRecoverySend(PasswordRecoveryModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (customer != null && customer.Active && !customer.Deleted)
                {
                    ...
                    var passwordRecoveryToken = GeneratePassword();
