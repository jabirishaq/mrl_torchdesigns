...
namespace Nop.Admin.Models.Settings
{
    public partial class NewsSettingsModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("moderator .news.emailid")]
        public string EmailIdforreciveNewsComment { get; set; }
        public bool EmailIdforreciveNewsComment_OverrideForStore { get; set; }
    }
}