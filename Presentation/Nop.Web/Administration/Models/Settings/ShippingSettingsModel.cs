...
namespace Nop.Admin.Models.Settings
{
    public partial class ShippingSettingsModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.Shipping.FreeShippingCostForUPSAndUSPS")]
        public decimal FreeShippingCostForUPSAndUSPS { get; set; }
        public bool FreeShippingCostForUPSAndUSPS_OverrideForStore { get; set; }
    }
}