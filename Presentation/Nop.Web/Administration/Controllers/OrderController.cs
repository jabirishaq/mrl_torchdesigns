...
namespace Nop.Admin.Controllers
{
	public partial class OrderController : BaseAdminController
    {
        ...
        protected virtual void PrepareOrderDetailsModel(OrderModel model, Order order)
        {
            ...
            string orderSubtotalDiscountInclTaxStr = _priceFormatter.FormatPrice((decimal.Truncate(100 * order.OrderSubTotalDiscountInclTax) / 100), true, primaryStoreCurrency, _workContext.WorkingLanguage, true);
            ...
            string orderSubtotalDiscountExclTaxStr = _priceFormatter.FormatPrice((decimal.Truncate(100 * order.OrderSubTotalDiscountExclTax) / 100), true, primaryStoreCurrency, _workContext.WorkingLanguage, false);
            ...
            if (order.OrderDiscount > 0)
                model.OrderTotalDiscount = _priceFormatter.FormatPrice(-(decimal.Truncate(100 * order.OrderDiscount) / 100), true, false);
            ...
            //model.OrderTotal = _priceFormatter.FormatPrice((decimal.Truncate(100 * order.OrderTotal) / 100), true, false);
            ...
            model.CanMarkOrderAsAuthorized = _orderProcessingService.CanMarkOrderAsAuthorized(order);
        ...
        [HttpPost, ActionName("Edit")]
        [FormValueRequired("markorderasauthorized")]
        public ActionResult MarkOrderAsAuthorized(int id)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageOrders))
                return AccessDeniedView();
        ...
        public ActionResult BestsellersReport()
        {
            ...
            //billing countries
            foreach (var c in _countryService.GetAllCountriesForBilling(true).Where(x => x.Name != "United States"))
            {
                model.AvailableCountries.Add(new SelectListItem() { Text = c.Name, Value = c.Id.ToString() });
            }
        ...
        [HttpPost]
        public ActionResult SalesReportList(DataSourceRequest command, SalesReportModel model)
        {
            ...
            DateTime? endDateValue = (model.EndDate == null) ? null
                ...
                var items = _orderReportService.SalesRepeortItem(startDateValue, endDateValue, command.Page - 1, command.PageSize,model.OrderStatusId,model.PaymentStatusId);
            
            var gridModel = new DataSourceResult
            {
                Data = items.Select(x =>
                    new SalesReportLineModel()
                    {
                        ProductId = x.Id,
                        ProductName = x.Name,
        ...
        [HttpPost]
        public string SalesReportAllList(DataSourceRequest command, SalesReportModel model)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageOrders))
                return "";
            ...
            var items = _orderReportService.SalesRepeortItem(startDateValue, endDateValue, command.Page - 1, 10000, model.OrderStatusId, model.PaymentStatusId);
            var gridModel = new DataSourceResult
            {
                Data = items.Select(x =>
                    new SalesReportLineModel()
            ...
            return JsonConvert.SerializeObject(gridModel.Data);
        }
        ...
        [HttpPost]
        public ActionResult SoldItemList(DataSourceRequest command, SoldListModel model)
        {
            ...
            {
                TimeSpan ts = new TimeSpan(model.StartTime, 00, 0);
                startDateValue = startDateValue.Value.Date + ts; 
            }
            ...
            {
                TimeSpan tes = new TimeSpan(model.EndTime, 00, 0);
                endDateValue = endDateValue.Value.Date + tes;
            }

            var items = _orderReportService.SoldItemList(startDateValue, endDateValue, command.Page - 1, command.PageSize,model.StartTime,model.EndTime);

            var gridModel = new DataSourceResult
            {
                Data = items.Select(x =>
                    new SoldListLineModel()
                    {
                        ProductId = x.Id,
                        ProductName = x.Name,
                        TotalProduct = x.TotalProduct
        ...
        public ActionResult OrderAverageReportList(DataSourceRequest command)
        {
            ...
            report.Add(_orderReportService.OrderAverageReport(0, OrderStatus.Transmitted));
          ...
          public ActionResult StateReport()
        {
            ...
            var model = new StateReportModel();
        ...
        [HttpPost]
        public ActionResult StateReportList(DataSourceRequest command, StateReportModel model)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.OrderCountryReport))
                return Content("");
            ...
            var items = _orderReportService.GetStateReport(
                os: orderStatus,
                ps: paymentStatus,
                startTimeUtc: startDateValue,
                endTimeUtc: endDateValue);
            var gridModel = new DataSourceResult
            {
                Data = items.Select(x =>
                {
                    var state = _stateProvinceService.GetStateProvinceById(x.StateProvinceId.HasValue ? x.StateProvinceId.Value : 0);
                    var m = new StateReportLineModel()
                    {
                        StateName = state != null ? state.Name : "Unknown",
                        SumOrders = _priceFormatter.FormatPrice(x.SumOrders, true, false),
                        TotalOrders = x.TotalOrders,
                    };
                    return m;
        ...
        public static IEnumerable<SelectListItem> GetTimeIntervalList()
        {
            List<SelectListItem> lstTime = new List<SelectListItem>();
            lstTime.Add(new SelectListItem() { Text = "00", Value = "00" });
            lstTime.Add(new SelectListItem() { Text = "01", Value = "01" });
            lstTime.Add(new SelectListItem() { Text = "02", Value = "02" });
            lstTime.Add(new SelectListItem() { Text = "03", Value = "03" });
            lstTime.Add(new SelectListItem() { Text = "04", Value = "04" });
            lstTime.Add(new SelectListItem() { Text = "05", Value = "05" });
            lstTime.Add(new SelectListItem() { Text = "06", Value = "06" });
            lstTime.Add(new SelectListItem() { Text = "07", Value = "07" });
            lstTime.Add(new SelectListItem() { Text = "08", Value = "08" });
            lstTime.Add(new SelectListItem() { Text = "09", Value = "09" });
            lstTime.Add(new SelectListItem() { Text = "10", Value = "10" });
            lstTime.Add(new SelectListItem() { Text = "11", Value = "11" });
            lstTime.Add(new SelectListItem() { Text = "12", Value = "12" });
            lstTime.Add(new SelectListItem() { Text = "13", Value = "13" });
            lstTime.Add(new SelectListItem() { Text = "14", Value = "14" });
            lstTime.Add(new SelectListItem() { Text = "15", Value = "15" });
            lstTime.Add(new SelectListItem() { Text = "16", Value = "16" });
            lstTime.Add(new SelectListItem() { Text = "17", Value = "17" });
            lstTime.Add(new SelectListItem() { Text = "18", Value = "18" });
            lstTime.Add(new SelectListItem() { Text = "19", Value = "19" });
            lstTime.Add(new SelectListItem() { Text = "20", Value = "20" });
            lstTime.Add(new SelectListItem() { Text = "21", Value = "21" });
            lstTime.Add(new SelectListItem() { Text = "22", Value = "22" });
            lstTime.Add(new SelectListItem() { Text = "23", Value = "23" });
