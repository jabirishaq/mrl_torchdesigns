...
namespace Nop.Admin.Controllers
{
    public partial class SettingController : BaseAdminController
    {
        ...
        public ActionResult News()
        {
            ...
            if (storeScope > 0)
            {
                model.EmailIdforreciveNewsComment_OverrideForStore = _settingService.SettingExists(newsSettings, x => x.Enabled, storeScope);
        ...
        public ActionResult News(NewsSettingsModel model)
        {
            ...
            if (model.EmailIdforreciveNewsComment_OverrideForStore || storeScope == 0)
                _settingService.SaveSetting(newsSettings, x => x.EmailIdforreciveNewsComment, storeScope, false);
            else if (storeScope > 0)
                _settingService.DeleteSetting(newsSettings, x => x.EmailIdforreciveNewsComment, storeScope);
        ...
        public ActionResult Shipping()
        {
            ...
            if (storeScope > 0)
            {
                ...
                model.FreeShippingCostForUPSAndUSPS_OverrideForStore = _settingService.SettingExists(shippingSettings, x => x.FreeShippingCostForUPSAndUSPS, storeScope);
            }
            //shipping origin
        ...
        public ActionResult Shipping(ShippingSettingsModel model)
        {
            ...
            if (model.FreeShippingCostForUPSAndUSPS_OverrideForStore || storeScope == 0)
                _settingService.SaveSetting(shippingSettings, x => x.FreeShippingCostForUPSAndUSPS, storeScope, false);
            else if (storeScope > 0)
                _settingService.DeleteSetting(shippingSettings, x => x.FreeShippingCostForUPSAndUSPS, storeScope);
            ...
            if (model.ShippingOriginAddress_OverrideForStore || storeScope == 0)
            {
                ...
                originAddress = CommonHelper.FormatAddress(originAddress);
        ...
        public ActionResult Catalog()
        {
            ...
            if (storeScope > 0)
            {
                ...
                //model.SupportEnabled_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.SupportEnabled, storeScope);
        ...
        public ActionResult Catalog(CatalogSettingsModel model)
        {
            ...
            //    _settingService.SaveSetting(catalogSettings, x => x.SupportEnabled, storeScope, false);
            //else if (storeScope > 0)
            //    _settingService.DeleteSetting(catalogSettings, x => x.SupportEnabled, storeScope);
        ...
        public ActionResult GeneralCommon()
        {
            ...
            model.StoreInformationSettings.ShowSystemDesign = storeInformationSettings.ShowSystemDesign;
            //override settings
            if (storeScope > 0)
            {
                ...
                model.StoreInformationSettings.ShowSystemDesign_OverrideForStore = _settingService.SettingExists(storeInformationSettings, x => x.ShowSystemDesign, storeScope);
            }
            ...
            model.SecuritySettings.CaptchaShowOnFinalStepBeforeCreditCardProcessed = captchaSettings.ShowOnFinalStepBeforeCreditCardProcessed;
        ...
        public ActionResult GeneralCommon(GeneralCommonSettingsModel model)
        {
            ...
            storeInformationSettings.ShowSystemDesign = model.StoreInformationSettings.ShowSystemDesign;
            ...
            if (model.StoreInformationSettings.ShowSystemDesign_OverrideForStore || storeScope == 0)
                _settingService.SaveSetting(storeInformationSettings, x => x.ShowSystemDesign, storeScope, false);
            else if (storeScope > 0)
                _settingService.DeleteSetting(storeInformationSettings, x => x.ShowSystemDesign, storeScope);
            ...
            captchaSettings.ShowOnFinalStepBeforeCreditCardProcessed = model.SecuritySettings.CaptchaShowOnFinalStepBeforeCreditCardProcessed;
