...
namespace Nop.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            //System Design Help
            routes.MapLocalizedRoute("systemdesigndhelpstep1",
                            "systemdesigndhelpstep1",
                            new { controller = "SystemDesignHelp", action = "Step1" },
                            new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("systemdesigndhelpstep2",
                            "systemdesigndhelpstep2",
                            new { controller = "SystemDesignHelp", action = "Step2" },
                            new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("systemdesigndhelpstep3",
                            "systemdesigndhelpstep3",
                            new { controller = "SystemDesignHelp", action = "Step3" },
                            new[] { "Nop.Web.Controllers" });
            ...
            routes.MapLocalizedRoute("productcategory",
                           "productcategory",
                           new { controller = "Catalog", action = "MainProductCategory" },
                           new[] { "Nop.Web.Controllers" });
            ...
            routes.MapRoute("GetDownloadfile",
                        "download/dowloadfile/{productid}/{downloadid}",
                        new { controller = "Download", action = "Dowloadfile" },
                        new { productid = @"\d+" },
                        new[] { "Nop.Web.Controllers" });
            ...
            //get state list by country ID  (AJAX link) for concate three country of usa
            routes.MapRoute("GetStatesByCountryIdCustome",
                            "country/getstatesbycountryidcustome/",
                            new { controller = "Country", action = "GetStatesByCountryIdCustome" },
                            new[] { "Nop.Web.Controllers" });
            ...
            routes.MapRoute("storelocator",
                            "storelocator",
                            new { controller = "TorchDesign_StoreLocator", action = "PublicInfo" },
                            new[] { "Nop.Plugin.Widgets.TorchDesign_StoreLocator.Controllers" });

            routes.MapRoute("Faqpublicinfo",
                           "faqpublicinfo",
                           new { controller = "FrequentlyAskedQ", action = "PublicInfo" },
                           new[] { "Nop.Plugin.TorchDesign.FAQ.Controllers" });

            routes.MapRoute("Testimonials",
                          "testimonials",
                          new { controller = "Testimonials", action = "PublicInfo" },
                          new[] { "Nop.Plugin.TorchDesign.Testimonials.Controllers" });

            routes.MapRoute("Support",
                         "support",
                         new { controller = "Support", action = "PublicInfo" },
                         new[] { "Nop.Plugin.TorchDesign_Support.Controllers" });

            //routes.MapRoute("SupportCategory",
            //         "supportcategory/{productCategoryId}",
            //         new { controller = "Support", action = "SupportCategory" },
            //          new { productCategoryId = @"\d+" },
            //         new[] { "Nop.Plugin.TorchDesign_Support.Controllers" });

            routes.MapRoute("CompanyHistory",
                          "misterlandscaperhistory",
                          new { controller = "Catalog", action = "History" },
                          new[] { "Nop.Web.Controllers" });
        
           routes.MapRoute("Mission",
                          "misterlandscapermission",
                          new { controller = "Catalog", action = "Mission" },
                          new[] { "Nop.Web.Controllers" });


           routes.MapRoute("Wateringtips",
                          "Wateringtips",
                          new { controller = "Catalog", action = "Wateringtip" },
                          new[] { "Nop.Web.Controllers" });

           routes.MapRoute("MadeinUsa",
                          "madeinusa",
                          new { controller = "Catalog", action = "Madeinusa" },
                          new[] { "Nop.Web.Controllers" });

            routes.MapRoute("DownloadPDFInstruction",
                          "download-pdf",
                          new { controller = "Catalog", action = "DownloadPDFInstruction" },
                          new[] { "Nop.Web.Controllers" });
        }
