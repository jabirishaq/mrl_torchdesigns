...
namespace Nop.Plugin.TorchDesigns.DynamicsGP
{
    class SendNewOrdersTask : ITask
    {
        ...
        public SendNewOrdersTask(IOrderService orderService, ISettingService settingService, ILogger logger, IShippingService shippingService, IGenericAttributeService genericAttributeService, 
