...
namespace Nop.Plugin.Shipping.USPS
{
    ...
    public class USPSComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        ...
        public USPSComputationMethod(IMeasureService measureService,
            ...
            IOrderTotalCalculationService orderTotalCalculationService, IRepository<StateProvince> stateRepository, IRepository<Country> countryRepository)
        {
        ...
        private string CreateRequest(string username, string password, GetShippingOptionRequest getShippingOptionRequest)
        {
            ...
            else
            {
                ...
                //var countryName = getShippingOptionRequest.ShippingAddress.Country.ThreeLetterIsoCode == "USA" ? "United States" : getShippingOptionRequest.ShippingAddress.Country.Name;
                //USPS country hacks
        ...
        public GetShippingOptionResponse GetShippingOptions(GetShippingOptionRequest getShippingOptionRequest)
        {
            ...
            if (String.IsNullOrEmpty(error))
            {
                foreach (var shippingOption in shippingOptions)
                {
                   ...
                   if(shippingOption.Rate > 0 && (!isDomestic || getShippingOptionRequest.ShippingAddress.Country.ThreeLetterIsoCode == "USA" ))
        ...
        {
            //get { return null; }
            get { return new USPSShipmentTracker(); }
        }
