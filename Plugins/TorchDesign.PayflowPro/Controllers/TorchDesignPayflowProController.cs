...
using Nop.Plugin.TorchDesign.PayflowPro;
using Nop.Plugin.TorchDesign.PayflowPro.Models;
using Nop.Plugin.TorchDesign.PayflowPro.Validators;
...
namespace Nop.Plugin.TorchDesign.PayflowPro.Controllers
{
    public class TorchDesignPayflowProController : BasePaymentController
    {
        ...
        public TorchDesignPayflowProController(IWorkContext workContext,
        ...
        public ActionResult Configure()
        {
            ...
            var payPalDirectPaymentSettings = _settingService.LoadSetting<TorchDesignPayflowProSettings>(storeScope);
            ...
            model.Partner = payPalDirectPaymentSettings.Partner;
            model.Vendor = payPalDirectPaymentSettings.Vendor;
            ...
            if (storeScope > 0)
            {
                ...
                model.Partner_OverrideForStore = _settingService.SettingExists(payPalDirectPaymentSettings, x => x.Partner, storeScope);
                model.Vendor_OverrideForStore = _settingService.SettingExists(payPalDirectPaymentSettings, x => x.Vendor, storeScope);
            }

            return View("~/Plugins/TorchDesign.PayflowPro/Views/PayflowPro/Configure.cshtml", model);
        }
        ...
        public ActionResult Configure(ConfigurationModel model)
        {
            ...
            payPalDirectPaymentSettings.Vendor = model.Vendor;
            payPalDirectPaymentSettings.Partner = model.Partner;
            ...
            if (model.Vendor_OverrideForStore || storeScope == 0)
                _settingService.SaveSetting(payPalDirectPaymentSettings, x => x.Vendor, storeScope, false);
            else if (storeScope > 0)
                _settingService.DeleteSetting(payPalDirectPaymentSettings, x => x.Vendor, storeScope);
            if (model.Partner_OverrideForStore || storeScope == 0)
                _settingService.SaveSetting(payPalDirectPaymentSettings, x => x.Partner, storeScope, false);
            else if (storeScope > 0)
                _settingService.DeleteSetting(payPalDirectPaymentSettings, x => x.Partner, storeScope);
        ...
        public ActionResult PaymentInfo()
        {
            ...
            return View("~/Plugins/TorchDesign.PayflowPro/Views/PayflowPro/PaymentInfo.cshtml", model);
        }
        ...
        //    var processor = _paymentService.LoadPaymentMethodBySystemName("TorchDesignPayflowPro") as TorchDesignPayflowProProcessor;
        //    if (processor == null ||
