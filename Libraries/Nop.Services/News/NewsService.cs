...
namespace Nop.Services.News
{
    ...
    public partial class NewsService : INewsService
    {
        ...
        public virtual NewsItem Getlastnews()
        {
            //var query = (from news in _newsItemRepository.Table select news).LastOrDefault();

            //return query;
            return _newsItemRepository.Table.ToList().LastOrDefault();
        }

        public virtual void ApprovedComment(NewsComment newsComment)
        {
            if (newsComment == null)
