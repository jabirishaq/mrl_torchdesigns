...
namespace Nop.Services.Messages
{
    public partial interface IMessageTokenProvider
    {
        ...
        void AddShipmentTokens(IList<Token> tokens, Shipment shipment, int languageId,string trackingUrl = null);
        ...
        void AddBlogPostTokensForActivatioCode(IList<Token> tokens, BlogComment blogComment);

        void AddSystemHelpTokens(IList<Token> tokens, SystemDesignHelp systemdesign);

        
        void AddBlogPostTokens(NewsLetterSubscription subscription,IList<Token> tokens, BlogPost blogpost, string seName);

        void AddNewsCommentTokens(IList<Token> tokens, NewsComment newsComment);
       
        void AddNewsCommentTokensForActivationcode(IList<Token> tokens, NewsComment newsComment);
