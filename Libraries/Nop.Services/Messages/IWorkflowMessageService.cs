...
namespace Nop.Services.Messages
{
    public partial interface IWorkflowMessageService
    {
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendBlogCommentNotificationMessageWithActivationCode(BlogComment blogComment, int languageId);

        
        /// <summary>
        /// Sends a new blog Post  message to a store owner
        /// </summary>
        /// <param name="Blogpost">Blog Post</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendNewBlogPostNotificationMessage(NewsLetterSubscription subscription, string email, BlogPost blogpost, int languageId, string seName);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendNewsCommentNotificationWithActivationCode(NewsComment newsComment, int languageId);
        ...
        /// <summary>
        /// Sends a 'SystemDesignHelpNotification' notification message to a customer
        /// </summary>
        /// <param name="subscription">Subscription</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendSystemDesignHelpNotification(SystemDesignHelp systemdesign, int languageId);
        ...
        /// <returns></returns>
        int SendCreditCardDeclineMessage(Customer customer, int languageId,
