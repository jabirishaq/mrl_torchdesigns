...
namespace Nop.Services.Directory
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        /// Gets a State
        /// </summary>
        /// <param name="countryId">State identifier</param>
        /// <returns>Country</returns>
        ...
        /// <returns>Country</returns>
        public virtual Country GetCountryByCountryName(string countryName)
        {
            var query = from c in _countryRepository.Table
        ...
        /// <summary>
        /// Gets a country by three letter ISO code custome
        /// </summary>
        /// <param name="threeLetterIsoCode">Country three letter ISO code</param>
        /// <returns>Country</returns>
        public virtual IList<Country> GetAllUsaCountryCustome()
        {
            var query = from c in _countryRepository.Table
                        where c.ThreeLetterIsoCode == "USA" || c.ThreeLetterIsoCode == "UMI"
                        select c;
