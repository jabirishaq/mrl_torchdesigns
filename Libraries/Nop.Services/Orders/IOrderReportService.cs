...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderReportService
    {
        ...
        IList<OrderByStateReportLine> GetStateReport(int storeId = 0, OrderStatus? os = null,
          PaymentStatus? ps = null, ShippingStatus? ss = null,
          DateTime? startTimeUtc = null, DateTime? endTimeUtc = null);
        ...
        IPagedList<Product> SalesRepeort(int pageIndex, int pageSize);
        /// <summary>
        /// Get profit report
        /// </summary>
        /// <param name="storeId">Store identifier</param>
        ...
        IPagedList<Nop.Services.Orders.OrderReportService.ProductItem> SalesRepeortItem(DateTime? startTimeUtc, DateTime? endTimeUtc, int pageIndex, int pageSize, int? OrderStatusId, int? PaymentStatusId);

        IPagedList<Nop.Services.Orders.OrderReportService.ProductItem> SoldItemList(DateTime? startTimeUtc, DateTime? endTimeUtc, int pageIndex, int pageSize, int startTime,int EndTime);
    }
}
