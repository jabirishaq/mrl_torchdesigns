...
namespace Nop.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        public PictureService(IRepository<ProductThumb> productPictureThumbRepository,IRepository<Picture> pictureRepository,
        ...
        public virtual IList<ProductThumb> GetPicturesthumbByProductId(int productId, int recordsToReturn = 0)
        {
            if (productId == 0)
                return new List<ProductThumb>();


            var query = from p in _productPictureThumbRepository.Table
