...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerRegistrationService : ICustomerRegistrationService
    {
        ...
        public virtual CustomerLoginResults ValidateCustomer(string usernameOrEmail, string password)
        {
            ...
            customer = _customerService.GetCustomerByUsernameorEmailId(usernameOrEmail);
            if (customer == null)
            ...
            string pwd = "";
            string genericAttributePassword = customer.GetAttribute<string>(SystemCustomerAttributeNames.PasswordRecoveryToken);
            if (string.IsNullOrEmpty(genericAttributePassword))
            {
            ...
            {
                if (password == genericAttributePassword)
                {
                    switch (customer.PasswordFormat)
                    {
                        case PasswordFormat.Encrypted:
