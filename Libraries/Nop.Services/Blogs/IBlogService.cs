...
namespace Nop.Services.Blogs
{
    ...
    public partial interface IBlogService
    {
        ...
        /// <summary>
        /// Gets all commentsbyblogpostid
        /// </summary>
        /// <param name="customerId">Customer identifier; 0 to load all records</param>
        /// <returns>Comments</returns>
        IList<BlogComment> GetAllCommentsByBlogPostId(int blogpostid);
        ...
        void DeleteBlogComment(BlogComment blogComment);
         ...
         BlogPost Getlastblogbody();

         void ApprovedComment(BlogComment blogComment);
    }
}
