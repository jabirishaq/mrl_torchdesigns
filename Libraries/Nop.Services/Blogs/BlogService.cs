...
namespace Nop.Services.Blogs
{
    ...
    public partial class BlogService : IBlogService
    {
        ...
        /// <summary>
        /// Gets all comments byblogpostid
        /// </summary>
        /// <param name="customerId">Customer identifier; 0 to load all records</param>
        /// <returns>Comments</returns>
        public virtual IList<BlogComment> GetAllCommentsByBlogPostId(int blogpostid)
        {
            var query = from c in _blogCommentRepository.Table
                        orderby c.CreatedOnUtc
        ...
        public virtual BlogPost Getlastblogbody()
        {
            return  _blogPostRepository.Table.ToList().LastOrDefault();

        }

        public virtual void ApprovedComment(BlogComment blogComment)
        {
            if (blogComment == null)
                throw new ArgumentNullException("No Comment Found For This Id");
