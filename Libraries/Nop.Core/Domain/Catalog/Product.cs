...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported
    {
        ...
        private ICollection<ProductDownload> _productDownloads;
        private ICollection<Download> _Downloads;
        private ICollection<ProductVideo> _productvideopictures;
        ...
        private ICollection<ProductCustomeField> _productcustomefield;
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to  ShowMaximumRuns
        /// </summary>
        ...
        public virtual ICollection<ProductVideo> ProductvideoPictures
        {
            get { return _productvideopictures ?? (_productvideopictures = new List<ProductVideo>()); }
            protected set { _productvideopictures = value; }
        }
        ...
        public virtual ICollection<ProductDownload> ProductDownloadsP
        {
            get { return _productDownloads ?? (_productDownloads = new List<ProductDownload>()); }
            protected set { _productDownloads = value; }
        }

        /// <summary>
        /// Gets or sets the product tags
        /// </summary>
        //public virtual ICollection<ProductCustomeField> ProductCustomField
        //{
        //    get { return _productcustomefield ?? (_productcustomefield = new List<ProductCustomeField>()); }
        //    protected set { _productcustomefield = value; }
        //}
